...
const Form = () => {
    ...
    const submitForm = async(e)=>{
        ...
        try {
            await axios.post("http://management-system-g7rv.onrender.com/api/v1/form/createForm", data);

            // Creating PDF Api call
            await axios.post('http://management-system-g7rv.onrender.com/api/v1/form/createPdf', data);
            // Sending PDF to mail
            const sendPdfResponse = await axios.post("http://management-system-g7rv.onrender.com/api/v1/form/sendPdfToMail");
